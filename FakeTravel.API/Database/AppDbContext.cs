...
namespace FakeTravel.API.Database
{
    public class AppDbContext:IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //});
            var touristRouteData=File.ReadAllText(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location)+ 
                @"/Database/touristRoutesMockData.json");
            IList<TouristRoute> touristRoutes=JsonConvert.DeserializeObject<IList<TouristRoute>>(touristRouteData);
            modelBuilder.Entity<TouristRoute>().HasData(touristRoutes);

            var touristRoutePictureData = File.ReadAllText(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) +
